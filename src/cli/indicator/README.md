...
| 3  | Category             | 統計分野コード（小分類） | -  | -             | [Category一覧参照](###Category一覧) | （分野で大まかに検索したいときに使用）                                                                                                                                                                |
...
| 7  | Cycle                | データ周期        | -  | -             | 1,2,3,4                       | 1. 月, 2. 四半期 3. 年 4. 年度                                                                                                                                                            |
| 8  | RegionalRank         | 地域階級         | -  | -             | 1,2,3,4                       | 1. 国, 2. 全国（日本）, 3. 都道府県, 4. 市区町村                                                                                                                                                  |
| 9  | IsSeasonalAdjustment | 原数季調値        | -  | -             | 1,2                           | 1. 原数値   2. 季節調整値                                                                                                                                                                  |
| 10 | StatCode             | 統計コード        | -  | -             | [StatCode一覧](###StatCode一覧)   | 取得したい系列情報に紐付く統計コード                                                                                                                                                                 |
